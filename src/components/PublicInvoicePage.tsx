        ...
        {error ? (
          ...
          <div className="space-y-6">
            ...
            <div className="no-print pt-4 border-t border-slate-100 flex flex-col gap-2">
              ...
              <button
                onClick={onClose}
                className="w-full text-center py-2.5 bg-slate-900 hover:bg-slate-800 text-white font-extrabold text-xs rounded-xl transition-all cursor-pointer shadow-sm mt-1"
              >
                Close Receipt View
              </button>
            </div>
